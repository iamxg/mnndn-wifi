# Average the experimental results according the number of consumers
import re
import sys
import os
import numpy as np
...
def drawStatGraph(dataFilePath, dataFileDir, aveCol):
    ...
    plt1.axis([0, 10, 4, 10])
    plt2.axis([0, 10, -5, 15])
    plt3.axis([0, 10, 10, 200])
    plt4.axis([0, 10, 0, 2.5])
    ...
    for dataFileName in dataFileList:
        ...
        labelChar = "N=" + nodeNumber
        colorN = int(nodeNumber)/5 - 2
        color = colors[colorN]
