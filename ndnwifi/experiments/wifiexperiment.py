...
class wifiExperiment:
    ...
    def statisticResult(self, nodeSet, consumerSet, dataFilePath, isCarSTA):
        ...
        print "intPacLoss, intPacLossRate, dataPacLoss, dataPacLossRate=", intPacLoss,"|", intPacLossRate,"|", dataPacLoss,"|", dataPacLossRate
        statResult = str(self.nConsumers) + " " + str(self.nPings) + " " + str(aveDelay/self.nConsumers) \
