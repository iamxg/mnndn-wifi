...
class wifiExperiment:
    ...
    def statisticResult(self, consumerSet):
        statResult_file = open ("%s/statResult.dat" % self.workDir, "a")
        ...
        for line in input_file:
            ...
            aveDelay = aveDelay + (float(lineField[4].strip())-float(lineField[5].strip()))
            lineField = []
