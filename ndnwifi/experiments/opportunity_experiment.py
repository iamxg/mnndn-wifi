...
class OpportunityExperiment(wifiExperiment):
    ...
    def run(self):
        ...
        i = 1
        self.producerName.cmd("echo 'hello UoM!' | ndnpoke -w 800000 /ndnwifi/hello >opportunity-producer.txt &")
        if self.isVndn or self.isSumoVndn:
            self.producerSTA.cmd("echo 'hello UoM!' | ndnpoke -w 800000 /ndnwifi/hello >opportunity-producer.txt &")
        ...
        while i <= self.nPings:
            ...
            # the following three lines for V2I communication
            for consumer in consumerList:
            ...
            i=i+1
        # Specify the data file path to save the experimental data.
        #          dataFilePath = "%s/data/oppo" % self.workDir
        #dataFilePath = "%s/data/bread" % self.workDir
        # Call statisticData() in wifiexperiment.py to extract experimental data and calculate the experimental result.
